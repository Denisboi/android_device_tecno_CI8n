...
# Dynamic Partitions
BOARD_SUPER_PARTITION_SIZE := 9631465472
BOARD_SUPER_PARTITION_GROUPS := main

# it's not work :( BOARD_TECNO_DYNAMIC_PARTITIONS_PARTITION_LIST := system vendor product system_ext
# BOARD_TECNO_DYNAMIC_PARTITIONS_SIZE := 9627271168 # (BOARD_SUPER_PARTITION_SIZE - 4MB)
BOARD_MAIN_PARTITION_LIST := system vendor product system_ext
BOARD_MAIN_SIZE := 9627271168
# File systems
